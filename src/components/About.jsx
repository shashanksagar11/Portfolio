    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-20">
          Welcome to my portfolio! I'm a 2016 Electrical & Electronics Engineering graduate
          from Swami Vivekanand Technical University, and I've embarked on a journey into
